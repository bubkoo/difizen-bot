...
import { getDefaultDoc, getManualDoc, getREADME } from './doc'
...
export function getMatcher(terms: string[], locations: Location[]) {
  return (location: Location, text: string) => {
